<template>
  <section class="home">
    ...
    <column-group title="培训专栏" link="/trainColumn" style="background:#f5f5f5;margin-bottom:.32rem;margin-top:-.32rem;">
  ...
  data() {
    return {
      ...
      columnList: [
        {
          id: "c0001",
          title: "测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1",
